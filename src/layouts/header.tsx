    ...
    <div className='header  p-tb-12 p-lr-48'>
      <div className='head  p-tb-12 p-lr-48'>
        ...
        <ul className='nav-block'>
          <li className="nav m-lr-8 p-8"><a className="link" href="#policy"> 候選人主張</a></li>
          <li className="nav m-lr-8 p-8"><a className="link" href="#policy">最新活動</a></li>
          <li className="nav m-lr-8 p-8"><a className="link" href="#policy">政策議題</a></li>
          <li className="nav m-lr-8 p-8"><a className="link" href="#policy">小額捐款</a></li>
          <li className="nav m-lr-8 p-8"><a className="link" href="#policy">民眾服務信箱</a></li>
        </ul>
